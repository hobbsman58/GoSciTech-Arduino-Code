...
void loop(){
  ...
  /* If you got here, one or both of the bump switches was closed */

  if(digitalRead(LEFT_BUMP_PIN) != HIGH &&
  digitalRead(RIGHT_BUMP_PIN) != HIGH) {
    delay(3000);
    // Do I need a break between left and right here to ensure that the robot dosen't take the code literally; to the last microsecond?
