...
// Define Constants
const byte FORWARD_SPEED = 180;   // Define normal speeds
const byte BACKWARD_SPEED = 140;  // and backup/turn speed
const int  TURN_DURATION = 500;   // Turn time in microseconds
